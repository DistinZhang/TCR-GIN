...
# python utils/aggregate_remnants.py --components-dir /root/autodl-tmp/data_exploratory/transport/transport-Components --remnants-dir /root/autodl-tmp/data_exploratory/transport/transport-Remnants
...
# #
# python utils/aggregate_remnants.py --components-dir /root/autodl-tmp/data_metric/transport_111/transport_111-Components --remnants-dir /root/autodl-tmp/data_metric/transport_111/transport_111-Remnants
# python utils/aggregate_remnants.py --components-dir /root/autodl-tmp/data_metric/transport_185/transport_185-Components --remnants-dir /root/autodl-tmp/data_metric/transport_185/transport_185-Remnants
...
#
# python experiments/early_warning/run_experiments.py --config ./experiments/early_warning/configs/train-multisource-111.yaml
# python experiments/early_warning/run_experiments.py --config ./experiments/early_warning/configs/train-multisource-185.yaml
# python experiments/early_warning/run_experiments.py --config ./experiments/early_warning/configs/train-multisource-353.yaml
# python experiments/early_warning/run_experiments.py --config ./experiments/early_warning/configs/train-multisource-588.yaml
...
# python experiments/trajectory_analysis/test_properties.py --config experiments/trajectory_analysis/configs/test_properties_base_multisource-transport.yaml
...
# python experiments/trajectory_analysis/test_properties.py --config experiments/trajectory_analysis/configs/ablation/test_properties_ablation-transport.yaml
...
# python experiments/trajectory_analysis/test_properties.py --config experiments/trajectory_analysis/configs/sensitivity/test_properties_sensitivity-transport.yaml
...
#
# python experiments/early_warning/test_properties.py --config experiments/early_warning/configs/transport-111.yaml
# python experiments/early_warning/test_properties.py --config experiments/early_warning/configs/transport-185.yaml
...
# 
# python experiments/early_warning/calculate_decision_window.py --input_root "/root/autodl-tmp/data_metric/transport_111" --output_dir "experiments/early_warning/results/decision_window/transport-111" --initial_size 369 --collapse_target 0.30 --model_config "experiments/early_warning/configs/transport-111.yaml"
# python experiments/early_warning/calculate_decision_window.py --input_root "/root/autodl-tmp/data_metric/transport_185" --output_dir "experiments/early_warning/results/decision_window/transport-185" --initial_size 369 --collapse_target 0.50 --model_config "experiments/early_warning/configs/transport-185.yaml"
...
# #
# python experiments/early_warning/evaluate_classic_robustness.py --input_root "/root/autodl-tmp/data_metric/transport_111" --output_dir "experiments/early_warning/results/robustness_metrics/transport-111" --initial_size 369 --collapse_target 0.30 --model_config "experiments/early_warning/configs/transport-111.yaml"
# python experiments/early_warning/evaluate_classic_robustness.py --input_root "/root/autodl-tmp/data_metric/transport_185" --output_dir "experiments/early_warning/results/robustness_metrics/transport-185" --initial_size 369 --collapse_target 0.50 --model_config "experiments/early_warning/configs/transport-185.yaml"
...
# python experiments/collapse_profile/run_profile_experiments.py --config experiments/collapse_profile/configs/train/reddit_profile.yaml
