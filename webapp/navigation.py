...
PAGES = [
    ("Home", "app.py"),
    ("Network Setup", "pages/1_📊_Network_Setup.py"),
    ("Monitoring", "pages/2_⚡_Real_Time.py"),
    ("User Guide", "pages/3_📖_User_Guide.py"),
]
...
def render_appearance_selector() -> None:
    ...
    legacy_modes = {"浅色": "Light", "深色": "Dark", "跟随系统": "System"}
    current_mode = legacy_modes.get(
        st.session_state.get("appearance_mode", "Dark"),
        st.session_state.get("appearance_mode", "Dark"),
    )
