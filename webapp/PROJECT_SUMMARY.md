...
- `pages/1_📊_Network_Setup.py`: network import, collapse target setup, model loading, and setup summary.
- `pages/2_⚡_Real_Time.py`: attack sequence control, Warning Target input, simulation controls, monitoring panels, network view, and CSV export.
- `pages/3_📖_User_Guide.py`: bilingual English/Chinese user guide matching the current UI.
